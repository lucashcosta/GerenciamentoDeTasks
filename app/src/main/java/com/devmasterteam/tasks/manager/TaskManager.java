...
public class TaskManager {
    ...
    public void getList(final int filter, final OperationListener<List<TaskEntity>> listener) {
        AsyncTask<Void, Integer, OperationResult<List<TaskEntity>>> task = new AsyncTask<Void, Integer, OperationResult<List<TaskEntity>>>() {
            @Override
     ...
     */
    public void insert(final TaskEntity taskEntity, final OperationListener<Boolean> listener) {
        AsyncTask<Void, Integer, OperationResult<Boolean>> task = new AsyncTask<Void, Integer, OperationResult<Boolean>>() {
            ...
            protected OperationResult<Boolean> doInBackground(Void... voids) {
                return mTaskBusiness.insert(taskEntity);
            }
